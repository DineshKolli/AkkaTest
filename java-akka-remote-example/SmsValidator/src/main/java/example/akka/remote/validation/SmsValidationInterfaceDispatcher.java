...
public class SmsValidationInterfaceDispatcher extends UntypedActor {
    ...
    private ActorSelection selection = getContext().actorSelection("akka.tcp://SmsDaoCluster@" + CommonValidationActorMain.DAO_IP + ":" + CommonValidationActorMain.DAO_PORT + "/user/SmsDaoRouter");
